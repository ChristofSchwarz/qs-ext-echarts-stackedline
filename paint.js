            ...
            try {
                const totalsObj = await app.createGenericObject({
                    ...
                    qHyperCubeDef: {
                        ...
                        qInterColumnSortOrder: [1, 0, 2] //sortOrderCopy
                    }
                });

                if (layout.pConsoleLog) console.log('Session Object created for coloring and sorting:', totalsObj);
                ...
                // we're done parsing the temp object, we can destroy it now        
                // https://help.qlik.com/en-US/sense-developer/November2025/Subsystems/APIs/Content/Sense_ClientAPIs/CapabilityAPIs/AppAPI/destroySessionObject-method.htm
                app.destroySessionObject(totalsObj.layout.qInfo.qId);
